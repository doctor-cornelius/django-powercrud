...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        neapolitan_template_name = f"{Command.template_prefix}/object{suffix}"
        ...
        try:
            ...
            if not Path(target_dir).exists():
                try:
                    ...
                    target_dir = Engine.get_default().dirs[0]
                except (ImproperlyConfigured, IndexError):
                    raise CommandError("No app or project level template dir found.")
