...
The current installed-artifact harness covers the first-party DaisyUI and Bootstrap declarations explicitly. Treat additional package arrangements as a review and test-design task rather than assuming they receive the same automated coverage.
...
- Documentation tells users how to select the pack, load its assets, and align Crispy Forms.
